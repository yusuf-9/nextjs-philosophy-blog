    ...
    if (allClear) {
        ...
        try {
            ...
            if (!user) {
                ...
                <p><a href="http://localhost:3000/api/auth/local/verification/verify?id=${user._id}">Verify email</a></p>`
                    })
        ...
        if (email && !password) {
            try {
                ...
                if (userExists) {
                    ...
                    <p><a href="http://localhost:3000/auth/reset/${uid}">Reset password</a></p><p>The link will expire in 24 hours</p>`
                    })
